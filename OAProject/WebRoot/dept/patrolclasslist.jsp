...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		$(".save").click(function(){  //点击保存事件
			location.href="patrol!test.action?element="+getdata();
		});
		});
		...
		<div class="rightinfo">
			<div class="tools">
				<ul class="toolbar">
					...
					<li class="save">
						<span><img src="images/t02.png" /> </span>保存
					</li>
					<li class="del">
			...
			<table class="tablelist" id="tabProduct">
				...
				<c:forEach items="${plist}" var="patorl">
					<tr>
						...
						<td>${patorl.tisdo }</td>
						<td>
							<a href="patrol!toupd.action?patrol.pid=${patorl.pid }" class="tablelink">查看</a>
							<a onclick="return confirm('确认要删除吗？')"
							href="patrol!del.action?patrol.pid=${patorl.pid }" class="tablelink">
							删除</a>
						</td>
					</tr>
				</c:forEach>
			...
			<script type="text/javascript">
				...
				function topage(){
					location.href="patrol!seldata.action";
				}
			</script>
