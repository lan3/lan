...
<body>
    ...
    <form action="web!add.action" method="post">
    <ul class="forminfo">
    <li>
    ...
    <label>
    	...
    	<div class="vocation">
			<select name="w.classid" class="select3">
				<option>---选择班级---</option>
    ...
    <label>
    	...
    	<div class="vocation">
    	<select name="w.onjectname" class="select3">
    		<option>---选择科目</option>
    ...
    <label>
    	...
    	<div class="vocation">
    	<select name="w.empteach" class="select3">
    		<c:forEach items="${listclass}" var="class">
    ...
    <li><label>演示时间</label>
    	...
    	<input type="text" id="d11" readonly="readonly" class="scinput" class="Wdate"
							onclick="WdatePicker()" name="w.time" />
    <li><label>&nbsp;</label>
    	<input  type="submit" class="btn" value="项目评分"/></li>
    </ul> 
    </form>
    </div>
