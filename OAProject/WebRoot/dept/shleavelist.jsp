        ...
        function del(){
            ...
            function tosel1(){
	            ...
	            if(peid==${session.id}){  //查看的是自己
	         	...
	         	location.href="leave!seldata1?peid="+peid;
            }
            function tosel2(){
            	var t1= document.getElementById("d11").value;
	         	var t2= document.getElementById("d12").value;
	         	location.href="leave!seldata2?t1="+t1+"&t2="+t2;
            }
            function tosel3(){
            	location.href="leave!seldata3.action";
            }
            function check(){
            	var t1= document.getElementById("d11").value;
	         	var t2= document.getElementById("d12").value;
	...
	<body onload="gehang()">
		...
		<div class="rightinfo">
				...
				<c:forEach items="${list}" var="leave">
					<tr>
						...
						<td style="padding-top:0px">
							...
							<div id="${leave.LID }" style="display: none;" class="vocation">
							<select id="sel" onchange="toshenhe(${leave.LID },${leave.EID},this.value);" class="select3" >
								<option>-下一审核人-</option>
							...
							<c:if test="${leave.LSTATUS=='待审核' }">
								<a href="javascript:loc(${leave.LID },${leave.EID},this.value)" id="a1" class="tablelink">同意</a>
								<a href="leave!shenhe.action?leave.lid=${leave.LID }&status=0" id="a2" class="tablelink">不同意</a>
							</c:if>	
							<c:if test="${leave.LSTATUS=='审核成功'}">
			...
			<div class="tip">
				...
				<div class="tipbtn">
					<input name="" type="button" onclick="" class="sure"
						value="确定" />
					&nbsp;
			...
			<script type="text/javascript">
				...
				function toshenhe(val,eid,osid){
					...
					location.href="leave!shenhe.action?leave.lid="+val+"&osid="+osid+"&status=1";
				}
			</script>
	</body>
