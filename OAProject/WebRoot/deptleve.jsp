						...
						<tr>
							...
							<td>
								...
								<c:if test="${t.STARTS=='最终审核' }">
									<a href="leve!decty.action?s.leveid=${t.LEVEID }&sid=${t.SID}&classid=${t.CLASSID }&startdate=${t.STARTDATE }&endtime=${t.ENDTIME }&day=${t.DAY }&lcont=${t.LCONT }&starts=${t.STARTS }" class="tablelink">同意</a>
									<a href="leve!deptnty.action?s.leveid=${t.LEVEID }" class="tablelink">不同意</a>
								</c:if>
