...
<body>
    ...
    <form action="monmonadd" method="post">
    <ul class="forminfo">
    <li><label>收费项目</label>  
    <div class="vocation">
    ...
    <li><label>收费金额</label><input name="mon.moncount" type="text" class="dfinput" style="width:518px;"/></li>
    <li><label>经手人</label><input name="mon.sname" type="text" class="dfinput" style="width:518px;"/></li>
    <li><label>备注</label>
